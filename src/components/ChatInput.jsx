...
const ChatInput = ({ SetText, DarkMode, main, Text }) => {
  return (
    <div
      className={`w-full input h-16 flex justify-center items-center max-w-[700px] rounded-xl shadow-lg absolute left-1/2 bottom-0 transform -translate-x-1/2 -translate-y-1/2   ${
    ...
    >
      <div className="flex h-full justify-between shadow-2xl items-center w-full px-3 py-3">
        <input
          ...
          placeholder="Ask me anything about Web Dev or DSA."
